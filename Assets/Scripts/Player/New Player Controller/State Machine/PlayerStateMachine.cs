...
public class PlayerStateMachine : MonoBehaviour
{
    ...
    [SerializeField] int _numberOfJumps = 3;
    bool _isJumping;
    bool _isFlying;
    ...
    public int NumberOfJumps { get { return _numberOfJumps; } }
    ...
    void OnMovementInput(InputAction.CallbackContext ctx)
    {
        ...
        Debug.Log($"[Input] Movement Input Updated:" +
                  $"\nInput Vector: {_currentMovementInput}" +
                  $"\nMagnitude: {_currentMovementInput.magnitude}" +
                  $"\nIsMovementPressed: {_isMovementPresed}");

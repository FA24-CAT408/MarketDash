...
public class KCCPlayerController : MonoBehaviour, ICharacterController
{
    ...
    [Tooltip("Optional stable camera heading used for movement. Falls back to Main Camera when unassigned.")]
    [SerializeField] private Transform cameraMovementReference;
    ...
    public void SetCameraMovementReference(Transform movementReference)
    {
        cameraMovementReference = movementReference;
    }
    ...
    Vector3 ConvertToCameraSpace(Vector3 vectorToRotate)
    {
        ...
        Transform reference = cameraMovementReference != null
